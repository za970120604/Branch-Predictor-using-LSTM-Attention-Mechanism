There are 5 sub folders along with a report PDF in this folder : 

TA can only refer to report PDF and ./code/simpython/final.py and ./code/simpython/fsm.py to see how I implement my idea in code.
Other files or folders are just complementary.
